  ...
  return (
    <KnobProvider>
      <DndProvider backend={HTML5Backend}>
        <>
          <RunMenu pyCode={pyCode} canRun={canRun} currSlotNumber={currSlotNumber} missionSteps={missionSteps}/>
          {/* Pass currSlot and setCurrSlot to CodingTrack */}
          <CodingTrack setPyCode={setPyCode} 
              setCanRun={setCanRun} 
          ...
          <BluetoothUI currSlotNumber={currSlotNumber} missionSteps={missionSteps}/>
        </>
      </DndProvider>
    </KnobProvider>
  );
