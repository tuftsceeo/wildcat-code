        ...
        switch (currentView) {
            case 'profiles':
                ...
                return (
                    <div className={styles.detailView}>
                        <h2>Profiles</h2>
                        <p>Save and track student profiles and progress, create teacher profiles.</p>
            ...
            case 'reading':
                ...
                return (
                    <div className={styles.detailView}>
                        <h2>Reading</h2>
                        <p>Control reading difficulty, toggle on/off non-reader version.</p>
                        <button onClick={handleBack} className={styles.backButton}>◀</button>
                    </div>
                );
            case 'groupMode':
                ...
                return (
                    <div className={styles.detailView}>
                        <h2>Group Mode</h2>
                        <p>Use Group Mode to connect student devices to the teacher panel.</p>
                        <button onClick={handleBack} className={styles.backButton}>◀</button>
                    </div>
                );
            case 'steps':
            ...
            case 'accessibility':
                ...
                return (
                    <div className={styles.detailView}>
                        <h2>Accessibility</h2>
                        <p>Text-to-speech, color contrast, text size, language options.</p>
                        <button onClick={handleBack} className={styles.backButton}>◀</button>
                    </div>
                );
            case 'sounds':
                ...
                return (
                    <div className={styles.detailView}>
                        <h2>Sounds</h2>
                        <p>Control volume level, toggle sounds on/off for app and robot.</p>
                        <button onClick={handleBack} className={styles.backButton}>◀</button>
                    </div>
                );
            default:
                ...
                return (
                    <>
                        ...
                        <div className={styles.options}>
                            ...
                            <div className={styles.box} onClick={() => setCurrentView('profiles')}>
                            ...
                            {/* Reading setting box */}
                            <div className={styles.box} onClick={() => setCurrentView('reading')}>
                            ...
                            <div className={styles.box} onClick={() => setCurrentView('groupMode')}>
                            ...
                            {/* Steps setting box */}
                            <div className={styles.box} onClick={() => setCurrentView('steps')}>
                            ...
                            <div className={styles.box} onClick={() => setCurrentView('accessibility')}>
                                <img src={accessibilityIcon} className={styles.icon} alt="Accessibility Icon" />
                                <div className={styles.textWrapper}>
                                    <p className={styles.heading}>Accessibility</p>
                                    <p className={styles.bodyText}>Text-to-speech, color contrast, text size, language options.</p>
                                </div>
                            </div>
                            {/* Sounds setting box */}
                            <div className={styles.box} onClick={() => setCurrentView('sounds')}>
    ...
    return (
        <Portal>
            ...
            <div className={styles.background} ref={popupRef}>
                {renderContent()} {/* Render main or detailed view based on currentView state */}
            </div>
        </Portal>
    );
};
