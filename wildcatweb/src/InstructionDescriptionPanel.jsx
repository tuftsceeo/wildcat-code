...
const InstructionDescriptionPanel = ({
    ...
    const handlePlayClick = () => {
        if (onPlayAudio) {
            ...
            const textWithPauses = isMultiInstruction ? 
                addTTSPauses(descriptionText) : descriptionText;
    ...
    const renderIconOnly = () => {
        ...
        const iconSegments = segments.filter(segment => 
            segment.iconType || segment.isSeparator
        );
        ...
        return (
            <div className={styles.textIconContainer}>
                {segments.map((segment, index) => (
                    ...
                    !segment.isSeparator && 
                    <div key={index} className={styles.textIconPair}>
                        {/* Text part */}
                        <div className={styles.pairText}>{segment.text}</div>
    ...
    const panelHeightClass = readingLevel === "icon_only" || 
    ...
    return (
        ...
        >
            <div className={`${styles.contentWrapper} ${getReadingLevelClass()}`}>
                {renderContent()}
            </div>
