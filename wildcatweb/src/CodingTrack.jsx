    ...
    /*  const [{ isOver }, drop] = useDrop({
        ...
        drop: (item) => {
            ...
            setDroppedItems((prevItems) => {
                ...
                if (item.type === ItemType.MOTOR_DASH) {
                    ...
                    if (
                        ...
                        updatedCodeDictionary[currSlot] =
                            (updatedCodeDictionary[currSlot] ??
                                `${currSlot + 1}: `) +
                            `[motor${item.port}-${item.selectedButtonRef.current}${item.knobAngle}]`;
                    } else {
                        // Case for one motor
                        setOnTrack(oneMotor);
                        ...
                        updatedCodeDictionary[currSlot] = `${
                            ...
                            item.selectedButtonRef.current
                        }${item.knobAngle}]`;
                    }
                    ...
                    updatedCodeDictionary[currSlot] = `${
                        currSlot + 1
                    }: [ColorSensor-${item.currentColorRef.current}]`;
                ...
                return prevItems.length < missionSteps
                    ? [...prevItems, item]
                    : prevItems;
            });
        },
